    ...
    <AnimatePresence>
      {open && (
        <>
          ...
          >
            <div className="bg-background/95 dark:bg-neutral-900/95 backdrop-blur-xl rounded-2xl border border-foreground/10 shadow-2xl overflow-hidden">
              {/* Search input */}
              <div className="flex items-center gap-3 px-4 py-3 border-b border-foreground/10">
                ...
                />
                <kbd className="text-xs text-muted-foreground bg-foreground/10 px-2 py-1 rounded font-mono">ESC</kbd>
              </div>
                    ...
                    {filtered
                      ...
                      .map((cmd) => (
                        <button
                          key={cmd.id}
                          onClick={cmd.action}
                          className="w-full flex items-center gap-3 px-4 py-2.5 text-sm text-foreground hover:bg-foreground/10 transition-colors text-left"
                        >
              ...
              {/* Footer */}
              <div className="px-4 py-2 border-t border-foreground/10 flex items-center gap-4 text-xs text-muted-foreground">
                <span><kbd className="font-mono bg-foreground/5 px-1.5 py-0.5 rounded">↑↓</kbd> navigate</span>
                <span><kbd className="font-mono bg-foreground/5 px-1.5 py-0.5 rounded">↵</kbd> select</span>
                <span className="ml-auto">
                  <kbd className="font-mono bg-foreground/5 px-1.5 py-0.5 rounded">⌘K</kbd> to toggle
                </span>
              </div>
            </div>
          </motion.div>
